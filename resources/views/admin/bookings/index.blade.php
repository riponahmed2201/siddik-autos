                                ...
                                <tbody>
                                    @forelse($bookings as $booking)
                                        <tr>
                                            ...
                                            <td>{{ $booking->journey_date ? $booking->journey_date->format('M d, Y') : '-' }}</td>
                                            <td>
                                                <span class="badge @class(['bg-warning'=>$booking->status==='pending','bg-success'=>$booking->status==='confirmed','bg-danger'=>$booking->status==='cancelled'])">{{ ucfirst($booking->status) }}</span>
                                            </td>
                                            <td>
