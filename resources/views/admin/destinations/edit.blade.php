                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" id="zone" name="zone">
                                        ...
                                        <option value="Zone 1" {{ old('zone', $destination->zone) == 'Zone 1' ? 'selected' : '' }}>Zone 1</option>
                                        <option value="Zone 2" {{ old('zone', $destination->zone) == 'Zone 2' ? 'selected' : '' }}>Zone 2</option>
                                        <option value="Zone 3" {{ old('zone', $destination->zone) == 'Zone 3' ? 'selected' : '' }}>Zone 3</option>
                                        <option value="Zone 4" {{ old('zone', $destination->zone) == 'Zone 4' ? 'selected' : '' }}>Zone 4</option>
                                        <option value="Zone 5" {{ old('zone', $destination->zone) == 'Zone 5' ? 'selected' : '' }}>Zone 5</option>
                                    </select>
                                </div>
                            </div>
