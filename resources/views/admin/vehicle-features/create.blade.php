...
@section('title', 'Create Vehicle Feature')

@section('content')
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Create Vehicle Feature</h1>
        <nav>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.vehicle-features.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
